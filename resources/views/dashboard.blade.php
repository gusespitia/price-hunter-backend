            ...
            <div class="overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
                    <div class="col-span-1 md:row-span-3 bg-blue-500 text-white p-4 rounded-lg shadow-lg flex items-center justify-center">
                        <img src="{{ asset('images/pricehunter_logo.png') }}" alt="Dashboard Price Hunter" class="w-32 h-32">
                    </div>
                    ...
                    <div class="bg-purple-500 text-white p-4 rounded-lg shadow-lg lg:row-start-2 lg:col-start-3">
                    ...
                    <div class="bg-red-600 text-white p-4 rounded-lg shadow-lg md:col-span-2 lg:col-span-3">
